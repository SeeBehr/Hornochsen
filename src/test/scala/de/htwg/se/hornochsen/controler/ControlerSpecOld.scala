...
class InterfaceControlerspecOld extends AnyWordSpec {
    ...
    var controler1 = summon[de.htwg.se.hornochsen.controler.InterfaceControler]
    var controler2 = summon[de.htwg.se.hornochsen.controler.InterfaceControler]
